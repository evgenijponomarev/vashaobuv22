...
const API_PASSWORD_FILE_NAME = `api-password.${DATA_FORMAT}`;
...
const getBanners = () => fs.readdirSync(BANNERS_DIR_PATH);
...
const getStoresPhotos = () => fs.readdirSync(STORES_PHOTOS_DIR_PATH);
...
const getApiPassword = () => fs.readFileSync(API_PASSWORD_FILE_PATH);
